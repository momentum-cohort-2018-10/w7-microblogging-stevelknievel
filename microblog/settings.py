...
SECRET_KEY = 'it1!q^@9jp)&u3&=noy%fyn!&y)wab#kkyy$1z6!1921(tl#n*'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PERMISSION_CLASSES': [
        # use this because only showing data for now
        'rest_framework.permissions.AllowAny',
        # BUT use this one or another restricted permission if you update your API to allow update and deleting
